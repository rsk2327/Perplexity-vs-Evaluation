...
MODEL_REVISION = "31310c323b20df84a8e33b832d4b01b4a4dd2324"
GPU_CONFIG = modal.gpu.A100(size="80GB", count=3)
...
app = modal.App("c4ai-command-r-plus-batch-perplexity-inference")
